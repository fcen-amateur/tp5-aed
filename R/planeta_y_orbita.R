...
radios_planeta <- runif( n = 200, min = 0, max= 4 )
angulos_planeta <- runif( n = 200, min = 0, 2*pi )
...
radios_anillo <- runif( n = 200, min = 5, max= 5.5 )
angulos_anillo <- runif( n = 200, min = 0, 2*pi )
