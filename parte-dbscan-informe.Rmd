...
```{r planetas mal evaluados, warnings=F}
...
Un efecto interesante observado es cómo en el *Algoritmo 2 con epsilon suficiente* el algoritmo logra no crear una clase que no se condice con la solución que queremos recurriendo a clasficar puntos como ruido, mostrando que este es el recurso para los conjuntos patológicamente complejos donde no alcanza con determinar el radio de vecindad para lograr la separación deseada. 
